...
-- Tiempo de generación: 03-10-2023 a las 21:55:18
...
(2, 'Pèrez ', 'Sofia', 'Còrdoba 1351', '4611223'),
(3, 'Torres', 'Martìn', 'San Juan 2720', '4896123'),
(4, 'López', 'Estela', 'Arijòn 3102', '4581246'),
(5, 'Molina ', 'Carla', 'Pueyrredòn 5177', '4633611');
...
(1, 'Lavarropas ', ' Dream Automàtico Concep 5.5/ 5 kg 500RPM Blanco', 201.679, 8, 1),
...
(8, 'Heladera', 'Samsung con Freezer Inverter Twin Cooling 330 Lts', 458.999, 2, 1),
...
(14, 'Notebook', 'Netgreen 14\" Cel 4GB 64GB W11 CG14', 171.507, 4, 1),
...
--
ALTER TABLE `detalleventa`
  MODIFY `id_detalleVenta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
